...
pre-release is published with eight downloadable assets. Windows/Linux CI and the tagged
build/verification workflow passed; all downloaded checksums and GitHub asset digests matched.
